...
class Sidebar
{
    ...
    public static function instance(){
        ...
        self::$_instance->addItem('Transactions', 'credit_card', 'transaction.index');
         self::$_instance->addItem('Testers', 'account_circle2', 'tester.index');
       self::$_instance->addItem('Sponsors', 'account_circle3', 'tester.index');
        self::$_instance->addItem('Certifiers', 'account_circle4', 'tester.index');
        self::$_instance->addItem('Pharmacies', 'colorize5', 'pharm.index');
