...
class Ethereum
{
    public $client;
    public $id = 0;
    public $convertHexToDecimal = true;
    ...
    private $inputMapper = [
        ...
        public $client1;
        public $id1 = 1;
        public $convertHexToDecimal1 = true;

        private $tester = array('tester_id', 'firstname', 'lastname', 'email', 'date_of_birth','address');
        private $tester_types_mask = array('int', 'string', 'string', 'string','string', 'string');

        private $inputMapper1 = [
            ...
            protected $client2;
            protected $id2 = 2;
            protected $convertHexToDecimal2 = true;

            private $sponsor = array('sponsor_id', 'firstname', 'lastname', 'email', 'date_of_birth','address');
            private $sponsor_types_mask = array('int', 'string', 'string', 'string','string', 'string');

            private $inputMapper2 = [
...
*/
                ...
                protected $client3;
                protected $id3 = 3;
                protected $convertHexToDecimal3 = true;

                private $certifier = array('certifier_id', 'firstname', 'lastname', 'email', 'date_of_birth','address');
                private $certifier_types_mask = array('int', 'string', 'string', 'string','string', 'string');

                private $inputMapper3 = [
    ...
    public function getDataHead($type)
    {
        ...
        switch (true) {
            case (strpos($type, '@') === 0):
                ...
                $obj->model = $model;
                return $obj;
            case (in_array($type, ['tester', 'farm'])):
                $obj->model = $this->tester;
                $obj->types = $this->tester_types_mask;
                return $obj;
