...
<div id="app">
    <header class="authHeader authHeaderHolder">
        <div class="authHeaderWrapper">
            ...
            <a target="_blank" href="<?php echo e(asset('help.pdf')); ?>" class="helpBtn">
            ...
            <div class="left">
                <div class="content">
                    <div class="logoHolder">
                        <div class="logo"></div>
                        <div class="caption">
                            <div class="text">hemp block DEMO</div>
...
<?php echo $__env->make('_partials.alert', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- Scripts -->
