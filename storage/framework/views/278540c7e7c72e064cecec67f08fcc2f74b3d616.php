...
//    var MARKER_PATH = 'http://files.softicons.com/download/web-icons/vista-map-markers-icons-by-icons-land/png/64x64/MapMarker_Marker_Inside_Pink.png';
    ...
    var placeID = document.getElementById('<?php echo e($idPlaceID); ?>');
    var latID = document.getElementById('<?php echo e($idLat); ?>');
    var lonID = document.getElementById('<?php echo e($idLon); ?>');
    ...
    function initAutocomplete() {
        ...
        autocomplete = new google.maps.places.Autocomplete(
            ...
            (document.getElementById('<?php echo e($idAutocomplete); ?>')),
            {types: ['geocode']}
        );
    ...
    function initMap(){
        ...
        // map options
        map = new google.maps.Map(document.getElementById('<?php echo e($idMap); ?>'), {
    ...
    function eventMarkerPlaced(marker) {
        ...
        geocoder.geocode({ latLng: marker.getPosition() }, function(results, status){
            ...
            if (status == google.maps.GeocoderStatus.OK)
            {
                ...
                document.getElementById('<?php echo e($idAutocomplete); ?>').value = results[0].formatted_address;
