...
class CreateSupplyTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('testers', function (Blueprint $table) {
            ...
            $table->string('address');
            $table->string('tx_test_id')->nullable();
        ...
        Schema::create('tester_properties', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
        ...
        Schema::create('tester_files', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('pharmacies', function (Blueprint $table) {
            ...
            $table->string('name');
            $table->string('address');
            $table->unsignedInteger('tx_pharm_id')->nullable();
            $table->unsignedInteger('tx_props_id')->nullable();
            $table->unsignedInteger('tx_files_id')->nullable();
            $table->text('json_props')->nullable();
            $table->text('json_files')->nullable();
        ...
        Schema::create('pharmacy_properties', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('value')->nullable();
            $table->string('eth_address')->nullable();
        ...
        Schema::create('pharmacy_files', function (Blueprint $table) {
            $table->increments('id');
            $table->string('filename');
            $table->string('extension')->nullable();
            $table->string('bytes')->nullable();
        ...
        Schema::create('sponsors', function (Blueprint $table) {
            ...
            $table->string('date_of_birth');
            $table->string('address');
            $table->string('tx_sponsor_id')->nullable();
            $table->string('tx_props_id')->nullable();
            $table->string('tx_files_id')->nullable();
            $table->text('json_props')->nullable();
            $table->text('json_files')->nullable();
        ...
        Schema::create('sponsor_properties', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('value')->nullable();
            $table->string('eth_address')->nullable();
        ...
        Schema::create('sponsor_files', function (Blueprint $table) {
            $table->increments('id');
            $table->string('filename');
            $table->string('extension')->nullable();
            $table->string('bytes')->nullable();
    ...
    Schema::create('certifiers', function (Blueprint $table) {
        ...
        $table->string('date_of_birth');
        $table->string('address');
        $table->string('tx_cert_id')->nullable();
        $table->string('tx_props_id')->nullable();
        $table->string('tx_files_id')->nullable();
        $table->text('json_props')->nullable();
        $table->text('json_files')->nullable();
   ...
   Schema::create('certifier_properties', function (Blueprint $table) {
        $table->increments('id');
        $table->string('name');
        $table->string('value')->nullable();
        $table->string('eth_address')->nullable();
    ...
    Schema::create('certifier_files', function (Blueprint $table) {
        $table->increments('id');
        $table->string('filename');
        $table->string('extension')->nullable();
        $table->string('bytes')->nullable();
    ...
    {
      Schema::dropIfExists('tester_files');
      Schema::dropIfExists('tester_properties');
      Schema::dropIfExists('testers');
      Schema::dropIfExists('sponsor_files');
      Schema::dropIfExists('sponsor_properties');
      Schema::dropIfExists('sponsors');
      Schema::dropIfExists('certifier_files');
      Schema::dropIfExists('certifier_properties');
  ...
  Schema::dropIfExists('pharmacies');
      Schema::dropIfExists('pharmacy_files');
        Schema::dropIfExists('pharmacy_properties');
    }
}
